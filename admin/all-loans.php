...
?>
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">All Loan Application</span>
    </nav>
                ...
                <div class="card overflow-hidden">
                    <div class="card-header bg-transparent pd-y-20 d-sm-flex align-items-center justify-content-between">
                        <div class="mg-b-20 mg-sm-b-0">
                            <h6 class="card-title mg-b-5 tx-13 tx-uppercase tx-bold tx-spacing-1">Loan Application</h6>
                            ...
                            <div class="col-12 pd-y-20 p-3 tx-left">
                                <div class="table-wrapper">
                                    <table id="AllLoans" class="table display responsive nowrap">
                                        ...
                                        <tbody>
                                        <?php
                                        $url = CONTROLLER_ROOT_URL."/v7/admin-fetch-all-loan-application.php";
