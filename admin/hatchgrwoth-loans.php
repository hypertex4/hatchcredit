...
<nav class="breadcrumb sl-breadcrumb">
    ...
    <span class="breadcrumb-item active">HatchGrowth Loan Application</span>
</nav>
            ...
            <div class="card overflow-hidden">
                <div class="card-header bg-transparent pd-y-20 d-sm-flex align-items-center justify-content-between">
                    <div class="mg-b-20 mg-sm-b-0">
                        <h6 class="card-title mg-b-5 tx-13 tx-uppercase tx-bold tx-spacing-1">HatchGrowth Loan Application</h6>
                        <span class="d-block tx-12">Here's a summary of all HatchGrowth transactions</span>
                    </div>
                </div>
                        ...
                        <div class="col-12 pd-y-20 p-3 tx-left">
                            <div class="table-wrapper">
                                <table id="AllLoans" class="table display responsive nowrap">
                                    ...
                                    <tbody>
                                    <?php
                                    $url = CONTROLLER_ROOT_URL."/v7/admin-fetch-loan-app-type.php?type=HatchGrowth";
