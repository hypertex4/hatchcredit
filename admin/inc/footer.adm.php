<footer class="sl-footer noprint">
    <div class="footer-left">
        <div class="mg-b-2">Copyright &copy; 2021. HatchCredit. All Rights Reserved.</div>
        <div>Powered by GreenWare Tech.</div>
    </div>
    <div class="footer-right d-flex align-items-center">
        <span class="tx-uppercase mg-r-10">Share:</span>
        <a target="_blank" class="pd-x-5" href="#"><i class="fa fa-facebook tx-20"></i></a>
        <a target="_blank" class="pd-x-5" href="#"><i class="fa fa-instagram tx-20"></i></a>
...
<script src="./assets/lib/jquery.steps/jquery.steps.js"></script>
